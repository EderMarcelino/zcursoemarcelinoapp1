		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zcursoemarcelinoapp1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcursoemarcelinoapp1-display": {
								"semanticObject": "zcursoemarcelinoapp1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcursoemarcelinoapp1",
									"url": sap.ui.require.toUrl("zcursoemarcelinoapp1")
								}
							}
						}
					}
